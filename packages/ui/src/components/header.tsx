...
<nav className="flex items-center h-20 w-360 flex-row items-center bg-black  box-border gap-176.5 border-b top-0 left-0 divide-solid	border-border ">
  <div className="flex items-left p-0 flex-col gap-2.5 w-64 h-20 border-r box-border border-solid border-solid	border-r-border flex-none grow-0 order-0 justify-center ">
      <span className='flex p-0 items-center flex-col gap-2 w-23.25 h-8.25 flex-none grow-0 order-0'> <img src={Logo} alt=""/></span>
  </div>
  

    <div className="h-full flex w-full flex-row	flex-wrap	content-center  item-center justify-end gap-4">
