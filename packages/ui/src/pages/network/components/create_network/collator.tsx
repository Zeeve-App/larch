  ...
  return (
    <div className=' flex-col flex'>
      ...
      <div className='flex justify-end py-4 gap-x-4'>
        <Link to="/template/createNetwork/parachain"><button className='text-white border-border border-2 rounded py-2 px-4 bg-gray'>Back</button></Link>
        <Link to="/template/createNetwork/hrmp"><button className='text-white border-border border-2 rounded py-2 px-4 bg-gray'>Next</button></Link>
      </div>
    </div>
  );
}
