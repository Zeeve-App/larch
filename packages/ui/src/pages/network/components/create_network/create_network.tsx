...
export default function CreateNetwork() {
  ...
  useEffect(() => {
    onload
    console.log('create netwrok page load')
  ...
  return (
    <div className=' flex-col flex'>
          ...
          <div className='w-max h-max border-border flex flex-col gap-y-3 rounded border-2 py-4 px-4'>
            <div className='flex gap-x-5 flex-row'>
              <div>
                ...
                <input className='bg-create-button border-border border-2 rounded w-[250px]'></input>
              </div>
        ...
        <div className='text-white pl-4 py-4 font-rubik flex flex-col gap-y-4'>
          <div className='flex flex-row gap-x-4'>
            <div className='flex gap-x-4'>
              ...
              <input className="bg-create-button border-border border-2 rounded"></input>
            </div>
            <div className='flex gap-x-4'>
      ...
      <div className='flex justify-end py-4 gap-x-4'>
        <Link to="/network"> <button className='text-white border-border border-2 rounded py-2 px-4 bg-gray'>Cancel</button></Link>
        <Link to="/template/createNetwork/relaychain"> <button className='text-white border-border border-2 rounded py-2 px-4 bg-gray'>Next</button></Link>
