              ...
              <div className='flex gap-x-4'>
                ...
                <div className='bg-black border-border border-2 rounded text-white  flex flex-row gap-x-12'>
                  ...
                  <span className='text-white py-1.5 px-1.5'>
                    {' '}
                    <span onClick={increase}><img className='w-3 h-3 ' src={IconUparrow} alt='' /></span>
                    <span><img className='w-3 h-3 ' src={IconDownarrow} alt='' onClick={decrease} /></span>
                  </span>
                </div>
              </div>
              <div className='flex gap-x-4'>
                ...
                <div className='bg-black border-border border-2 rounded text-white  flex flex-row gap-x-12'>
                  ...
                  <span className='text-white py-1.5 px-1.5'>
                    {' '}
                    <img className='w-3 h-3 ' src={IconUparrow} alt='' onClick={increase1} />
                    <img className='w-3 h-3 ' src={IconDownarrow} alt='' onClick={decrease1} />
                  </span>
