...
export default function DeletePopUpBox({
  isOpen, setIsOpen, onConfirm, name,
}: DeletePopUpBoxProps) {
  return (
    <Dialog
      open={isOpen}
        ...
        <Dialog.Panel className='w-max max-w-lg rounded bg-create-button border-border border-4 p-4'>
          ...
          <div className='flex flex-col gap-y-6'>
            ...
            <div className='flex flex-row justify-between'>
              <button className='border-2 border-border rounded-lg py-1.5 px-2 bg-green hover:bg-dark-green text-white font-bold' onClick={() => onConfirm(name)}>Confirm</button>
